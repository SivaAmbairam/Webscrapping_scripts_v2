...
if __name__ == "__main__":
    connection_file = r'C:\Users\G6\PycharmProjects\WebScrappingWebPage/Scrapping Scripts/Output/temp/db_connection_file.txt'
    connection = get_connection(connection_file)
    if connection:
        query = "SELECT * FROM FlinnCompetitors.Product_Comparison_Manual"
        export_csv_file_path = r'C:\Users\G6\PycharmProjects\WebScrappingWebPage/Scrapping Scripts/Output/Product_Comparison_Manual_export.csv'
        export_to_csv(query, export_csv_file_path, connection)
