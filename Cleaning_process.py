...
if __name__ == '__main__':
    ...
    demo_df = pd.read_csv('Scrapping Scripts/Output/Product_Comparison_Manual_export.csv')
    ...
    for i, demo_row in demo_df.iterrows():
        demo_flinn_id = demo_row['FLINN Part No. ']
        print(demo_flinn_id)
        demo_frey_id = demo_row['FREY Part No. ']
        demo_nasco_id = demo_row['NASCO Part No. ']
        demo_carolina_id = demo_row['CAROLINA Part No. ']
        demo_vwr_id = demo_row['VWR WARDS Part No. ']
        demo_fisher_id = demo_row['FISHER Part No. ']
        if 'WARDSCI Part No.' in str(demo_row):
            demo_wardsci_id = demo_row['WARDSCI Part No. ']
        else:
            demo_wardsci_id = ''
        flinn_match = {}
        frey_match = {}
        ...
        if flinn_match:
            ...
            if frey_match:
                ...
                if 'nan' not in str(demo_row['FREY Description']):
                    frey_match = {
                        'Frey_product_category': '',
                        'Frey_product_sub_category': '',
                        'Frey_product_id': demo_row['FREY Part No. '],
                        'Frey_product_name': demo_row['FREY Description'],
                        'Frey_product_quantity': demo_row['FREY Piece Count'],
                        'Frey_product_price': '',
            ...
            if nasco_match:
                ...
                if 'nan' not in str(demo_row['NASCO Description']):
                    nasco_match = {
                        'Nasco_product_category': '',
                        'Nasco_product_sub_category': '',
                        'Nasco_product_id': demo_row['NASCO Part No. '],
                        'Nasco_product_name': demo_row['NASCO Description'],
                        'Nasco_product_quantity': demo_row['NASCO Piece Count'],
                        'Nasco_product_price': '',
            ...
            if carolina_match:
                ...
                if 'nan' not in str(demo_row['CAROLINA Description']):
                    carolina_match = {
                        'Carolina_product_category': '',
                        'Carolina_product_sub_category': '',
                        'Carolina_product_id': demo_row['CAROLINA Part No. '],
                        'Carolina_product_name': demo_row['CAROLINA Description'],
                        'Carolina_product_quantity': demo_row['CAROLINA Piece Count'],
            ...
            if vwr_match:
                ...
                if 'nan' not in str(demo_row['VWR WARDS Description']):
                    vwr_match = {
                        'VWR_product_category': '',
                        'VWR_product_sub_category': '',
                        'VWR_product_id': demo_row['VWR WARDS Part No. '],
                        'VWR_product_name': demo_row['VWR WARDS Description'],
                        'VWR_product_quantity': demo_row['VWR WARDS Piece Count'],
                        'VWR_product_price': '',
            ...
            if fisher_match:
                ...
                if 'nan' not in str(demo_row['FISHER Description']):
                    fisher_match = {
                        'Fisher_product_category': '',
                        'Fisher_product_sub_category': '',
                        'Fisher_product_id': demo_row['FISHER Part No. '],
                        'Fisher_product_name': demo_row['FISHER Description'],
                        'Fisher_product_quantity': demo_row['FISHER Piece Count'],
            ...
            if wardsci_match:
                ...
                if 'WARDSCI Description' in str(demo_row):
                    if 'nan' not in str(demo_row['WARDSCI Description']):
                        wardsci_match = {
                            'Wardsci_product_category': '',
                            'Wardsci_product_sub_category': '',
                            'Wardsci_product_id': demo_row['WARDSCI Part No. '],
                            'Wardsci_product_name': demo_row['WARDSCI Description'],
                            'Wardsci_product_quantity': demo_row['WARDSCI Piece Count'],
